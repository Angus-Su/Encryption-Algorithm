 ...
 * Key Expansion
 */
void key_expansion_aes(uint8_t *key) {
...
void cipher_aes(uint8_t *in, uint8_t *out) {
...
void inv_cipher_aes(uint8_t *in, uint8_t *out) {
...
void ciper_init_aes(uint8_t key_size)
{
	switch (key_size) 
	{
		default:
